...
以及 B1 臺鐵穿堂、台北地下街 Y 區、站前地下街 Z 區、中山地下街 R 區與 K 區地下街。
四區具主要通廊、店鋪量體、代表出口與跨區導航；原車站路網仍支援無障礙模式（全程電梯＋寬閘門）。
...
車站核心幾何為公開站圖描繪；四區地下街依臺北市政府全區圖建立拓撲與相對方位示意。
每個元素均標示 source/confidence/status，地下街尺度、店鋪分段與 K 區邊界為低信心估算，非測量資料；高程全部估計。
